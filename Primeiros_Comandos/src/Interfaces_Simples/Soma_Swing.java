 ...
 * @author acer
 */
public class Soma_Swing extends javax.swing.JFrame {

    /**
     * Creates new form Soma_Swing
     */
    public Soma_Swing() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Soma_Swing.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Soma_Swing().setVisible(true);
            }
        });
    }
